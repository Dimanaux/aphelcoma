...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { description: @problem.description, title: @problem.title, user_id: @problem.user_id } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { description: @problem.description, title: @problem.title, user_id: @problem.user_id } }
